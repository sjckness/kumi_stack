...
def generate_launch_description():
    ...
    absolute_namespace = PathJoinSubstitution([TextSubstitution(text="/"), namespace])

    declare_namespace = DeclareLaunchArgument(
        "namespace", description="Namespace for this robot runtime stack"
    )
    ...
    controllers_file = PathJoinSubstitution(
        [FindPackageShare("kumi_control"), "config", "trajectory_control_config.yaml"]
    )
